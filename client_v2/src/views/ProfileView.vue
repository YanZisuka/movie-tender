<template>
  <div
    v-if="isFetchedProfile"
    class="row justify-content-center align-items-center"
  >
    <div class="col-6 d-flex flex-column justify-content-center text-start">
      <div
        class="profile d-flex flex-row my-5 justify-content-start align-items-center"
      >
        <img :src="profileImg" alt="" />

        <div
          class="user-info d-flex flex-column justify-content-center align-items-start w-100 ms-5"
        >
          <div class="d-flex justify-content-between w-100">
            ...
            <div v-if="isMe && isEditing" style="height: 3rem">
              <button
                ...
                class="btn-profile me-3"
                style="height: 100%; background-color: #c4c4c4"
              >
                취소
              </button>
              <button
      ...
      <div v-if="false">
        ...
        <ul>
          <review-item
            v-for="review in profile.review_set"
            :key="review.id"
            :review="review"
          >
          </review-item>
